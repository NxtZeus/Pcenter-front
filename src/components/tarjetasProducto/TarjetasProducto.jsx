...
function TarjetaProducto({ producto, onAddToCart }) {
    // Obtiene la URL de la imagen del producto o una imagen por defecto si no hay imágenes disponibles para el producto actual
        ...
        <div className="border p-4 bg-white rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl flex flex-col justify-between min-h-[24rem] w-72">
            ...
            <div className="flex flex-col justify-between flex-1 p-4">
                <div>
                    ...
                    <h2 className="text-lg font-bold text-custom-azul">
                        <TruncarTexto text={producto.nombre_producto} maxLength={50} />
                    </h2>
                    {/* Precio del producto */}
