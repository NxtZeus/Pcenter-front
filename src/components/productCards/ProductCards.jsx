...
function ProductCard({ producto, onAddToCart }) {
    return (
        <div className="border p-4 bg-white rounded-md shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-custom-azul flex flex-col justify-between min-h-[24rem] w-72">
